...
const DashboardPage: React.FC = () => {
   ...
   const fetchBalance = useCallback(async () => {
      // 10 sn zaman aşımı ile daha deterministik ilk yükleme
      const controller = new AbortController();
      const timeoutId = setTimeout(() => controller.abort(), 10000);

      try {
         const response = await fetch('/api/transactions/balance', { signal: controller.signal });
         if (response.ok) {
      ...
      <>
         ...
         <Layout>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8">
               ...
               <div className={`group relative overflow-hidden bg-linear-to-br ${netBalance >= 0
                  ...
                  <div className={`absolute inset-0 bg-linear-to-br ${netBalance >= 0
                  ...
                  <div className="relative z-10 mb-6">
                     ...
                     <div className="text-center">
                        ...
                        <div className="mt-4 flex justify-center">
                           <div className={`px-4 py-2 rounded-full text-xs font-bold ${netBalance >= 0
